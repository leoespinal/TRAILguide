...
class DataService {
    ...
    private let campingProducts = [
        ...
        Product(_name: "CAMPING STOVE", _description: "A camping stove is a really nice addition to the camping experience. Forget about struggling to start a fire in a local camp grill, just fire up the Cole Burner 2018 which is a top rated propane stove.", _imageName: "campingStove.png"),
